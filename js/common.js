...
function createQuickNav(target){
    ...
    nav_html = '<span id="btn_quick_nav" class="btn mini mdi mdi-menu left hidden" title="Abrir menú de navegación"></span><div id="quick_nav" class="hidden lpadded mobile-lpadded"><h2>Menú de navegación</h2>';
