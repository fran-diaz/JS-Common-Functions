...
function createQuickNav(target){
    ...
    nav_html = '<span id="btn_quick_nav" class="btn mini mdi mdi-menu left hidden d-none" title="Abrir menú de navegación" style="position:fixed;top:0;left:0;z-index:9999;"></span><div id="quick_nav" class="hidden d-none lpadded mobile-lpadded"><h2>Menú de navegación</h2>';
